package com.example.bundles_practise
...
import com.example.bundles_practise.databinding.FragmentButtonBinding
...
class ButtonFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.button.setOnClickListener {
            ...
            val transferFragment=TextFragment()
            transferFragment.arguments=bundle
            parentFragmentManager.beginTransaction()
                .replace(R.id.main,TextFragment())
                .commit();
        }
